      ...
      <DialogContent className="bg-white">
        ...
        <div className="grid gap-4 py-4">
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="name" className="text-right text-[#1A3A3A]">
              Name
            </Label>
            <Input
              id="name"
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="sku" className="text-right text-[#1A3A3A]">
              SKU
            </Label>
            <Input
              id="sku"
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="quantity" className="text-right text-[#1A3A3A]">
              Quantity
            </Label>
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            <Label htmlFor="pricePerUnit" className="text-right text-[#1A3A3A]">
              Price per Unit
            </Label>
            <Input
              id="pricePerUnit"
